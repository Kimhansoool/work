...
const API_URL = '/eduSupportContent';

/** Ajax처리를 위한 미들웨어 함수 정의 */
export const getList = createAsyncThunk("EduSupContentSlice/getList", async (payload, { rejectWithValue }) => {
    let result = null;
...
const EduSupContentSlice = getDefaultSlice("EduSupContentSlice", [getList]);

export default EduSupContentSlice.reducer;